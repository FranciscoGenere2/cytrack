...
?>
		...
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
					...
					<td colspan="2">
						...
						<table>
							<tr><?php
								...
								<?php } ?>
								<td>
									<text class="negrita">Cliente: </text><?php echo $row['clientName'] ?>
									<br />
									<text class="negrita">Telefono: </text><?php echo $row['clientContact'] ?>
									<br />
				...
				<tr class="details">
					...
					<td colspan="4"><?php echo "$".$row['paid'] ?></td>
 ...
 <td rowspan="3" colspan="3" style="border: 1px solid #555">A/C NO:0064867230047 <br>SWIFT:DTDA1320
				...
				<tr class="total">
					...
					?>
					<!--<td>Monto:<b><?php echo $result . "DO  " . $points; ?></b></td>-->
					<td>Moneda:<b><?php echo  " Peso Dominicano" . $points; ?></b></td>
					<td>Total: <?php echo "$".$pepsi['totalAmount']; ?> </td>
				</tr>
			</table>
